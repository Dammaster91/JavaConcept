...
public class ConcurrentHashMapExamples {
	public static void main(String args[]) {
		...
		ConcurrentHashMap<String, Integer> programmingLanguages = new ConcurrentHashMap<String, Integer>();
		...
		Integer howOldIsJava = (Integer) programmingLanguages.get("Java");
		Integer howOldIsC = (Integer) programmingLanguages.get("C");
		...
		Set<Entry<String, Integer>> entrySet = programmingLanguages.entrySet();
		for (Entry<String, Integer> mapping : entrySet) {
		...
		Iterator<String> keys = programmingLanguages.keySet().iterator();
		while (keys.hasNext()) {
